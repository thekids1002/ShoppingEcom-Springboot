...
$.extend(jQuery.validator, {
    messages: {
        required: function (p, e) {
            return $.validator.format('{0} is required', [
                $(e).data('label'),
            ]);
        },
        maxlength: function (p, e) {
            return $.validator.format(
                '{0} please enter no more than {1} characters. (Currently {2} characters)',
                [$(e).data('label'), p, $(e).val().length]
            );
        },
        minlength: function (p, e) {
            return $.validator.format(
                '{0} please enter at least {1} characters. (Currently {2} characters)',
                [$(e).data('label'), p, $(e).val().length]
            );
        },
